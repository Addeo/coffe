  ...
  private staticAgreements: Map<AgreementType, AgreementContent> = new Map([
    [
      AgreementType.PRIVACY_POLICY,
      {
        ...
        content: `
          ...
          <p>Настоящая Политика конфиденциальности определяет порядок обработки и защиты персональных данных пользователей системы управления заявками ServiceCheck (далее — «Система»).</p>
    ...
    [
      AgreementType.TERMS_OF_SERVICE,
      {
        ...
        content: `
          <h2>1. Общие положения</h2>
          <p>Настоящее Пользовательское соглашение (далее — «Соглашение») определяет условия использования системы управления заявками ServiceCheck (далее — «Система»).</p>
    ...
    [
      AgreementType.DATA_PROCESSING,
      {
        ...
        content: `
          ...
          <p>Я, принимая настоящее согласие, подтверждаю, что предоставляю свое согласие на обработку моих персональных данных в системе управления заявками ServiceCheck (далее — «Оператор»).</p>
