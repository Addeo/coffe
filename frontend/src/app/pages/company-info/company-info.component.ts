  ...
  readonly industries: IndustrySnapshot[] = [
    {
      ...
      summary:
        'Полная поддержка кофейных баров: от настройки помола и рецептур до замены бойлеров и паровых кранов.',
      keyMetric: 'Среднее восстановление работоспособности — 2 часа 15 минут.',
    },
    {
      name: 'HoReCa и гостиницы',
      summary:
        'Составляем график ТО с учетом загрузки, обеспечиваем резервные аппараты и обучаем персонал дневной чистке.',
      keyMetric: '93% заказов закрываем без снятия машины с линии.',
    },
    {
      name: 'Офисы и коворкинги',
      summary:
        'Настраиваем кофейные зоны для сотрудников, обеспечиваем расходники и удаленный контроль состояния фильтров.',
      keyMetric: 'Экономия до 28% на расходных материалах за счет профилактики.',
    },
    {
      name: 'АЗС и мини-маркеты',
      summary:
        'Следим за чистотой гидросистем на точках с высокой проходимостью, оперативно выезжаем ночью и в праздники.',
  ...
  readonly stabilityHighlights: StabilityHighlight[] = [
    {
      ...
      detail:
        'Наш главный офис находится в Пятигорске. Отсюда мы координируем выезды по всему КМВ, Ставропольскому краю и ближайшим республикам.',
    },
    {
      title: 'Многолетний надежный опыт',
      detail:
        'Работаем с кофейным оборудованием много лет. Знаем особенности каждого аппарата и умеем быстро находить решения.',
    },
    {
      title: 'Свой склад запчастей',
      detail:
        'Храним бойлеры, прокладки, фильтры и краны под популярные модели в нашем складе в Пятигорске. За ними не нужно ждать доставки из других городов.',
    },
    {
      title: 'Регламентные осмотры',
      detail:
        'Напоминаем о профилактике, ведем историю каждой машины и говорим, что нужно поменять до того, как она остановится.',
    },
    {
      title: 'Прозрачные условия',
      detail:
        'Фиксированные тарифы, акты в день визита и единый контакт владельца — без call-центров и менеджеров.',
    },
  ];
  ...
  readonly gallery: GalleryItem[] = [
    {
      ...
      caption:
        'Выездной ремонт прямо на точке — большинство неисправностей закрываем за один визит.',
    },
    {
    ...
    },
    {
      ...
      caption:
        'После обслуживания обучаем персонал ежедневной чистке и записи параметров, чтобы техника служила дольше.',
    },
    {
  ...
  readonly workProcessSteps: WorkProcessStep[] = [
    {
      ...
      description:
        'Связываетесь с нами по телефону, email или через форму на сайте. Описываете проблему или запрашиваете профилактику.',
      icon: '📞',
    },
    {
      step: 2,
      ...
      description:
        'Договариваемся о удобном времени визита. Обычно выезжаем в течение 2–4 часов после обращения.',
      icon: '📅',
    },
    {
      step: 3,
      title: 'Выезд мастера',
      description:
        'Мастер приезжает с необходимым инструментом и запчастями. Проводит диагностику и устраняет проблему.',
      icon: '🔧',
    },
    {
      step: 4,
      ...
      description:
        'Выполняем ремонт, замену запчастей, чистку и настройку. Обучаем персонал правильному уходу.',
      icon: '⚙️',
    },
    {
      step: 5,
      ...
      description:
        'Оставляем фотоотчет о проделанной работе, рекомендации по уходу и напоминание о следующем ТО.',
      icon: '📋',
    },
  ];
  ...
  readonly advantages: Advantage[] = [
    {
      ...
      description:
        'Выезжаем в течение 2–4 часов после обращения. Работаем в будни, выходные и праздники.',
      icon: '⚡',
    },
    {
      title: 'Оригинальные запчасти',
      description:
        'Используем только оригинальные запчасти от производителей. Держим склад в Пятигорске.',
      icon: '✅',
    },
    {
      title: 'Опытные мастера',
      description:
        'Многолетний опыт работы с кофейным оборудованием. Знаем особенности каждой модели.',
      icon: '👨‍🔧',
    },
    {
    ...
    },
    {
      ...
      description:
        'Ведем полную историю обслуживания каждой кофемашины. Помним особенности вашего оборудования.',
      icon: '📊',
    },
  ];
    ...
    return [
      {
        ...
        description:
          'Регулярное обслуживание и настройка кофемашин. Стабильная работа без простоев.',
      },
      {
        name: 'Гостиница «Пятигорск»',
        industry: 'Пятигорск · HoReCa',
        description:
          'Поддерживаем кофейные станции в номерах и ресторанах. Быстрое реагирование на заявки.',
      },
      {
        name: 'АЗС «Лукойл»',
